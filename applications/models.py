...
class UndergraduateApplication(models.Model):
    ...
    country = CountryField()
        ...
        # course details
    course_of_study = models.ForeignKey('core.CourseOfStudy', on_delete=models.DO_NOTHING)
...
class ScholarshipApplication(models.Model):
    ...
    postal_code = models.CharField(max_length=255)
    country = CountryField( )
    course_applied = models.ForeignKey('core.CourseOfStudy', on_delete=models.DO_NOTHING)
    # scholarship 
